...
{
$results = mysqli_query($con,"DELETE from stu where StaffId ='$_GET[StaffId]'");
}
?>
...
while($arr=mysqli_fetch_array($res))
{
	...
	<td align='center'><a href='CStaffview.php?StaffId=$arr[StaffId]'>Delete</a></td>
	<td align='center'><a href='UpdateStaff.php?StaffId=$arr[StaffId]'>Update</a></td></tr>";
}	
