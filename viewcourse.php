...
{
$results = mysqli_query($con,"DELETE from coursedetails where courseid ='$_GET[courseid]'");
}
?>
...
<form id="form1" name="form1" method="post" action="">
		  <table width="531" border="1" align="center">
		    <tr>
		      <th width="130" scope="col">Course Id</th>
		      <th width="123" scope="col">Course Name</th>
		      <th width="138" scope="col">Duration</th>
...
{
	echo "<tr>
	<td>$arr[courseid]&nbsp;</td><td>$arr[coursename]&nbsp;</td>
	<td>$arr[courseduration]&nbsp;</td>
	
	<td align='center'><a href='viewcourse.php?courseid=$arr[courseid]'>Delete</a></td>
	<td align='center'><a href='updatecourse.php?courseid=$arr[courseid]'>Update</a></td></tr>";
}	
